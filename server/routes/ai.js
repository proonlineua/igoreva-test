...
router.post('/generate', async (req, res) => {
  ...
  const prompt = `Ты операционный консультант для салонов красоты. Создай профессиональный рабочий документ.

Документ: "${taskName}"
Салон: ${salonData?.name || 'Салон'}, ${salonData?.city || ''}, мастеров: ${salonData?.masters || 'н/д'}, средний чек: ${salonData?.avgCheck || 'н/д'} грн.
...
- Конкретные цифры, примеры, готовые формулировки
